Un **vector** es un segmento de recta que se encuentra ubicado en un espacio euclidiano ($\mathbb{R}^n$) que se encuentra orientado en un sentido y una dirección.
